object DrawingDialog: TDrawingDialog
  Left = 227
  Top = 108
  ...
  object gbLine: TGroupBox
    ...
    object feLWidth: TFloatRangeEdit
      Left = 15
      Top = 40
      Width = 46
      Height = 21
  ...
  object pcType: TPageControl
    ...
    object tsLine: TTabSheet
      ...
      object gbBegin: TGroupBox
        ...
        object feStartX: TFloatRangeEdit
          Tag = 4
          Left = 20
          Top = 35
          Width = 46
        ...
        object feStartY: TFloatRangeEdit
          Tag = 4
          Left = 100
          Top = 35
          Width = 46
        ...
        object cbStartArrow: TCheckBox
          Left = 185
          Top = 33
          Width = 81
          Height = 26
          Caption = 'With arrow head'
          TabOrder = 2
          WordWrap = True
        end
      end
  ...
  object pcProps: TPageControl
    ...
    object tsArrow: TTabSheet
      ...
      object gbHead: TGroupBox
        ...
        object feHdLength: TFloatRangeEdit
          Tag = 3
          Left = 35
          Top = 40
          Width = 46
        ...
        object feHdWidth: TFloatRangeEdit
          Tag = 3
          Left = 130
          Top = 40
          Width = 46
