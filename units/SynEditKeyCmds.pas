...
// TShiftState was extended in Delphi-XE2 to 10 elements allocating 2 bytes
// instead of 1 byte       - JR 20120-11-05
...
begin
  with AStream do begin
    ...
    Write(fShift, 1); //SizeOf(fShift));
    Write(fKey2, SizeOf(fKey2));
    Write(fShift2, 1); //SizeOf(fShift2));
