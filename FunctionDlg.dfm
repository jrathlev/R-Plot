object FunctionDialog: TFunctionDialog
  Left = 227
  Top = 108
  ...
  object edDescription: TLabeledEdit
    ...
    EditLabel.Width = 86
    EditLabel.Height = 13
    EditLabel.Caption = 'Name of function:'
    TabOrder = 2
  end
  ...
  object gbFuncRange: TGroupBox
    Left = 270
    Top = 90
    Width = 261
    Height = 76
    Caption = 'X range for function'
    TabOrder = 6
  ...
  object gbAngUnit: TGroupBox
    ...
    object Label1: TLabel
      ...
      Width = 62
      Height = 13
      Caption = 'Angular unit:'
    end
    object cbAngUnit: TComboBox
      Left = 110
      Top = 10
      Width = 91
      Height = 21
