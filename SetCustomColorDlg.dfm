object SetCustomColorDialog: TSetCustomColorDialog
  Left = 227
  Top = 108
  BorderIcons = [biMinimize, biMaximize]
  BorderStyle = bsDialog
  Caption = 'Add new color to list of user defined colors'
  ClientHeight = 207
  ClientWidth = 518
  Color = clBtnFace
  ...
  object Label2: TLabel
    ...
    Height = 31
    AutoSize = False
    Caption = 'Click a color button to replace the selected with new the color'
    WordWrap = True
  end
